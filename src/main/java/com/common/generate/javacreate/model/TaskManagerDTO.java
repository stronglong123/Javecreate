 ...
 * @date  2020-10-30
 */
public class TaskManagerDTO extends PageCondition implements Serializable {
     ...
     * 获取涉及项目
     */
    public void setRefProject (String refProject) {this.refProject = refProject;} 
    /**
     * 设置涉及项目
     */
    public String getRefProject(){ return refProject;} 
    /**
     ...
     * 获取截止时间
     */
    public void setDeadTime (Timestamp deadTime) {this.deadTime = deadTime;} 
    /**
     * 设置截止时间
     */
    public Timestamp getDeadTime(){ return deadTime;} 
    /**
     * 获取创建时间
     */
