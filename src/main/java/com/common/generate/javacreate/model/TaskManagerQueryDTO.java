 ...
 * @date  2020-10-30
 */
public class TaskManagerQueryDTO extends PageCondition implements Serializable {
     ...
     * 获取截止时间
     */
    public void setDeadTime (String deadTime) {this.deadTime = deadTime;}
    /**
     * 设置截止时间
     */
    public String getDeadTime(){ return deadTime;}
    /**
     * 获取创建时间
     */
