...
public class OrderItemAmountDTO implements Serializable {
    ...
    //(description = "应用接入方code")
    private String partnerCode;

    //(description = "订单明细id")
    private Long orderItemId;

    //(description = "原始订单金额", required = true)
    private BigDecimal originalOrderItemAmount;

    //(description = "订单金额", required = true)
    private BigDecimal orderItemAmount;

    //(description = "原始应付金额", required = true)
    private BigDecimal originalPayableAmount;

    //(description = "应付金额", required = true)
    private BigDecimal payableAmount;

    //(description = "原始优惠金额", required = true)
    private BigDecimal originalDiscount;

    //(description = "优惠金额", required = true)
    ...
    //(description = "作业中金额")
    @Deprecated
    private BigDecimal workingOrderItemAmount;

    //(description = "运费")
    private BigDecimal shippingRateAmount;

    public BigDecimal getWorkingOrderItemAmount() {
        return workingOrderItemAmount;
    }

    public void setWorkingOrderItemAmount(BigDecimal workingOrderItemAmount) {
        this.workingOrderItemAmount = workingOrderItemAmount;
    }
