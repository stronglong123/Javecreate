 ...
 * @Version 1.0
 **/
@ApiModel(description = "oms订单项优惠信息模型")
public class OrderItemDiscountBO {
     ...
     * orders表主键
     */
    @ApiParam(description = "orders表主键")
     ...
     * 优惠来源
     */
    @ApiParam(description = "优惠来源")
    private Integer sourceType;

    /**
     * 优惠来源ID
     */
    @ApiParam(description = "优惠来源ID")
    private Long sourceId;

    /**
     * 优惠分类
     */
    @ApiParam(description = "优惠分类")
    private Integer classify;

    /**
     * 修改时间
     */
    @ApiParam(description = "修改时间")
    private Date createTime;

    /**
     * 修改人
     */
    @ApiParam(description = "修改人")
